...
interface ScootOutcomeProps {
  cards?: OutcomeCard[];
}

const defaultCards: OutcomeCard[] = [
  {
    image: "/scoot-multidevice.png",
    imageAlt: "Fluid game mechanics — spatial avatar environment",
    video: "/mingle.mp4",
    title: "Fluid Game Mechanics and Interactions",
    intro: "Users can:",
    bullets: [
  ...
  {
    image: "/scoot-source-info.png",
    imageAlt: "Utilization of data — smart badge and meeting summaries",
    video: "/summary.mov",
    title: "Utilization of data at every touch point",
    intro: undefined,
    bullets: [
  ...
  {
    image: "/scoot-design-system.png",
    imageAlt: "Customizable environments — room configuration tools",
    video: "/roomcreater.mov",
    title: "Customizable environments to meet every use case",
    intro: undefined,
    bullets: [
...
export default function ScootOutcome({ cards = defaultCards }: ScootOutcomeProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {cards.map((card, i) => (
            ...
            >
              <div style={{ aspectRatio: "4/3", overflow: "hidden", backgroundColor: "var(--theme-surface-hover)" }}>
                {card.video ? (
                  <video
                    src={card.video}
                    autoPlay
                  ...
                  <Image src={card.image} alt={card.imageAlt} width={600} height={450} className="w-full h-full object-cover object-top" />
                )}
              </div>
