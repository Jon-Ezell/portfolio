...
const themes = [
  {
    ...
    vars: {
      ...
      // Hero overrides — cream hero looks like midnight
  ...
  },
  {
    ...
    vars: {
      ...
      "--theme-tree-blend": "screen",
      "--theme-tree-opacity": "0.45",
      "--theme-hero-bg": "#f0f5fb",
      "--theme-hero-text": "#0d1b2a",
      "--theme-hero-muted": "#3a5068",
      "--theme-hero-surface": "#e2ecf8",
      "--theme-hero-logo-filter": "none",
      "--theme-hero-tree-blend": "screen",
      "--theme-hero-tree-opacity": "0.45",
    },
  },
  {
    id: "forest",
    ...
    vars: {
      ...
      "--theme-tree-blend": "luminosity",
      "--theme-tree-opacity": "0.9",
      "--theme-hero-bg": "#0e1a10",
      "--theme-hero-text": "#dff0e0",
      "--theme-hero-muted": "#90c898",
      "--theme-hero-surface": "#142218",
      "--theme-hero-logo-filter": "brightness(0) invert(1)",
      "--theme-hero-tree-blend": "luminosity",
      "--theme-hero-tree-opacity": "0.9",
    },
  },
  {
    ...
    vars: {
      ...
      "--theme-tree-blend": "luminosity",
      "--theme-tree-opacity": "0.9",
      "--theme-hero-bg": "#0e0b1a",
      "--theme-hero-text": "#ede8f8",
      "--theme-hero-muted": "#b0a0e8",
      "--theme-hero-surface": "#160c28",
      "--theme-hero-logo-filter": "brightness(0) invert(1)",
      "--theme-hero-tree-blend": "luminosity",
      "--theme-hero-tree-opacity": "0.9",
    },
