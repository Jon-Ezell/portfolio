...
const themes = [
  ...
  },
  {
    ...
    vars: {
      ...
      "--theme-tree-blend": "luminosity",
      "--theme-tree-opacity": "0.9",
      "--theme-decor-filter": "brightness(0.35) saturate(0.6) hue-rotate(120deg)",
      "--theme-hero-bg": "#0e1a10",
      "--theme-hero-text": "#dff0e0",
      "--theme-hero-muted": "#aadfb5",
  ...
  },
  {
    ...
    vars: {
      ...
      "--theme-tree-blend": "luminosity",
      "--theme-tree-opacity": "0.9",
      "--theme-decor-filter": "brightness(0.35) saturate(0.6) hue-rotate(240deg)",
      "--theme-hero-bg": "#0e0b1a",
      "--theme-hero-text": "#ede8f8",
      "--theme-hero-muted": "#c8b9f5",
