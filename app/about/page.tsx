...
const history = [
  {
    ...
    company: "Scoot",
    description:
      "Led design and co-led product for an immersive virtual event startup. Shipped core product and closed first Fortune 500 deals.",
  },
  {
    year: "2024",
    role: "Design Consultant",
    company: "WELL — YC W23",
    description: "Designed core UX/UI and branding for YC-backed company WELL.",
  },
  {
    year: "2023",
    role: "Co-Founder",
    company: "Zephyr",
    description:
      "Co-founded a health and wellness startup — led all product, branding, and experience design.",
  },
  {
    year: "2023",
    role: "UX Consultant",
    company: "Reflection Sciences",
    description: "Led UX for a Gates Foundation-funded ed-tech startup.",
  },
  {
    year: "2022",
    role: "UX Designer",
    company: "ALTR",
    description:
      "Led design for a VC-funded data security startup. Grew ARR from $100K → $1M+ and activation from 7% → 60%.",
  },
  {
    year: "2019",
    role: "Web Designer",
    company: "CAVIS",
    description: "Reimagined branding and web assets for an energy optimization company.",
  },
];
