...
// ── Main export ───────────────────────────────────────────────────────────────
/**
 * @param {{ container: HTMLElement, theme?: string, windowTouch?: boolean }} options
 * @returns {{ dispose: () => void, setTheme: (name: string) => void, setParams: (p: Record<string, string | number>) => void }}
 */
